...
class KerasQuantize(Quantize):
    ...
    def quantize_keras_model_to_tflite(self,
        ...
        Usage:
            ...
            quantize_keras_model_to_tflite(
        ...
        if quantize_output:
            ...
            converter._experimental_disable_quantization_for_model_outputs = True
    ...
    def __call__(self,
        ...
        return self.quantize_keras_model_to_tflite(self, keras_model_path, tflite_model_path, calibration_data_path,preprocess_function,
                                                    quantize_input, quantize_output)
